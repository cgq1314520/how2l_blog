        ...
        <div class="zhuanti whitebg">
            ...
            <ul>
                <c:forEach items="${AllVideoInfo}" var="message" varStatus="info">
                    ...
                    <li><i class="ztpic"><a href="videoDetail?dbID=${message.dbId}" target="_blank"><img
                            src="static/images/1.jpg"></a></i><i class="ztpic zhezhang"
                                                                 style="background-color: black;"><a
                            href="videoDetail?dbID=${message.dbId}" target="_blank"></a></i> <span><a
                            href="videoDetail?dbID=${message.dbId}">${message.title}</a></span></li>
                </c:forEach>
            </ul>
        </div>
